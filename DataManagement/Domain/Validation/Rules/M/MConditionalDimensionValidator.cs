...
namespace WAD.Runner.DataManagement.Domain.Validation.Rules.M;

/// <summary>
/// Validates the dimensions required by the selected M
/// feed-hole type and foot option.
/// </summary>
internal static class MConditionalDimensionValidator
{
        ...
        switch (footOption)
        {
            ...
            case "":
                AddPropertyIssue(
                    ...
                    FootOptionProperty,
                    "field is empty. Expected LW_VG, LW_C, LW_G, LW_F or LW_CC.");
                break;
            ...
            default:
                AddPropertyIssue(
                    ...
                    FootOptionProperty,
                    $"unsupported value '{raw}'. Expected LW_VG, LW_C, LW_G, LW_F or LW_CC.");
                break;
        }
    }
