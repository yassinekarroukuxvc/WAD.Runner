...
namespace WAD.Runner.DataManagement.Domain.Validation.Rules.FP;

/// <summary>
/// Validates the dimensions required by the selected FP
/// feed-hole type and foot option.
/// </summary>
internal static class FpConditionalDimensionValidator
{
