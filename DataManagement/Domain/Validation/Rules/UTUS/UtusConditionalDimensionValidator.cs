...
namespace WAD.Runner.DataManagement.Domain.Validation.Rules.UTUS;

/// <summary>
/// Validates the dimensions required by the selected UTUS
/// feed-hole type and foot option.
/// </summary>
internal static class UtusConditionalDimensionValidator
{
        ...
        List<DimensionValidationIssue> issues)
    {
        ...
        switch (footOption)
        {
            ...
            default:
                // Any other foot option has no additional UTUS dimension rules.
                break;
        }
    }
