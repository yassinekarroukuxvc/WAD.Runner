...
public static class WedgeDataAssembler
{
        ...
        IEnumerable<PgbSpec2RowDto> spec2Rows)
    {
        ...
        var props = new Dictionary<string, string?>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["PGB-Engrave"] = NullIfWhite(spec1.Engrave),
            ["PGB-Coining"] = NullIfWhite(spec1.FLBlank),

            ["PGB-Dwg-Text1"] = NullIfWhite(spec1.DwgText1),
            ["PGB-Dwg-Text2"] = NullIfWhite(spec1.DwgText2),
            ["PGB-Dwg-Text3"] = NullIfWhite(spec1.DwgText3),
            ["PGB-Dwg-Text4"] = NullIfWhite(spec1.DwgText4),
            ["PGB-Dwg-Text5"] = NullIfWhite(spec1.DwgText5),
            ["PGB-Dwg-Text6"] = NullIfWhite(spec1.DwgText6),
            ["PGB-Dwg-Text7"] = NullIfWhite(spec1.DwgText7),

            ["PGB-Type"] = NullIfWhite(spec1.WedType),
            ["PGB-Foot_Option"] = NullIfWhite(spec1.WedFootOption),
            ["PGB-Wire_Exit"] = NullIfWhite(spec1.WedWireExit),
            ["PGB-Feed_H/Slot"] = NullIfWhite(spec1.WedFeedHSlot),
