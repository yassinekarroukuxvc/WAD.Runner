...
public sealed class _1001ToleranceRules : IToleranceRuleSet
{
        ...
        WedgeSubclass subclass)
    {
        ...
        Logger.Info(
            $"[_1001ToleranceRules] Planned updates={updates.Count} " +
        ...
        _1001ShankType shank)
    {
        ...
        Logger.Info(
            "[_1001ToleranceRules] Overlay cut reference points -> " +
            $"shank={shank}, " +
        ...
        bool hasVrVw)
    {
        ...
        {
            Logger.Warn(
                "[_1001ToleranceRules] VW is present but W is missing/not a length. " +
    ...
    {
        Logger.Warn(
            $"[_1001ToleranceRules] Missing/invalid nominal/tolerance for '{dimensionKey}'. " +
