...
///
/// F foot:
///     STD -> std_fr_f_feature + std_br_f_feature ON,
...
public sealed class _1001FeatureRules : IFeatureRuleSet
{
        ...
        FootOptionType footOption)
    {
        switch (footOption)
        {
            ...
            default:
                throw new InvalidOperationException(
                    "Unable to resolve the _1001 foot option for an FG wedge. " +
                    "Expected LW_/SW_ C, VG, G, F or CC.");
        }
    }
        ...
        FeatureFamily family)
    {
        ...
        {
            throw new InvalidOperationException(
                "_1001 C foot has incomplete CBR dimensions. " +
    ...
    private static _1001ShankType ResolveShankType(
        WedgeFacts facts)
    {
        var token =
            NormalizePackedToken(
        ...
        WedgeFacts facts)
    {
        ...
        {
            Logger.Warn(
                "[_1001FeatureRules] VW is present but W is missing/not a length. " +
        ...
        WedgeFacts facts)
    {
        ...
        {
            throw new InvalidOperationException(
                "Cannot apply _1001 C-foot rules because FRO is missing/not a length.");
        }
