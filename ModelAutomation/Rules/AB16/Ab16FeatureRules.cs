...
///
/// FG:
///     same PGB base rules plus ERW, core fillet, FRO and round BR always on.
...
public sealed class Ab16FeatureRules : IFeatureRuleSet
{
        ...
        FeedHoleType feedHoleType)
    {
        ...
        switch (feedHoleType)
        {
            ...
            default:
                throw new InvalidOperationException(
                    "Unable to resolve the AB16 feed-hole type for an FG wedge. " +
        ...
        FootOptionType footOption)
    {
        ...
        switch (footOption)
        {
            ...
            default:
                throw new InvalidOperationException(
                    "Unable to resolve the AB16 foot option for an FG wedge. " +
