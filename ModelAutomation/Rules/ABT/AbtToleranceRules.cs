...
/// </summary>
public sealed class AbtToleranceRules : IToleranceRuleSet
{
        ...
        WedgeSubclass subclass)
    {
        ...
        {
            Logger.Info(
                "[AbtToleranceRules] Non-overlay drawing -> " +
        ...
        Logger.Info(
            $"[AbtToleranceRules] Planned updates={updates.Count} " +
        ...
        AbtShankType shank)
    {
        ...
        Logger.Info(
            "[AbtToleranceRules] Overlay tolerance selection -> " +
            $"subclass={subclass}, " +
            $"shank={shank}, " +
            $"VBL present={hasVbl}, " +
            $"RA2 present={hasRa2}, " +
        ...
        string prefix)
    {
        ...
        Logger.Info(
            "[AbtToleranceRules] FG foot tolerance selection -> " +
        ...
        bool hasVrVw)
    {
        ...
        {
            Logger.Warn(
                "[AbtToleranceRules] VW is present but W is missing " +
    ...
    {
        Logger.Warn(
            "[AbtToleranceRules] Missing or invalid nominal/" +
