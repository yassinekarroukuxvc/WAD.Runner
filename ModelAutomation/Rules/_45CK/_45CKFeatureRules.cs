...
///
///     right_view:
///         no VR/VW -> selects the PGB/FG W sketch.
///         VR/VW    -> suppresses the W sketch and selects the VR case sketch.
///
///     left_view selects the T case sketch.
///     VG overlay is available in both overlay configs.
///
...
public sealed class _45CKFeatureRules : IFeatureRuleSet
{
        ...
        FeatureRuleContext context)
    {
        ...
        if (context.DrawingType == DrawingType.Overlay)
        {
            ...
            ApplyOverlayRightViewRules(
                plan,
                context.Subclass,
                overlayView,
                overlayVwCase);

            ApplyOverlayLeftViewRules(
                plan,
                overlayView,
        ...
        OverlayVwCase overlayVwCase)
    {
         ...
         * IMPORTANT:
         *
         * When VR/VW is present and therefore a VR case exists,
         * the VR case sketch replaces the standalone W overlay
         * sketch completely.
         */
        if (overlayVwCase != OverlayVwCase.None)
        {
            ...
            Logger.Info(
                "[_45CKFeatureRules] Right overlay -> " +
        ...
        /*
         * No VR/VW:
         * use the normal subclass-specific W overlay sketch.
         */
        plan.ForceSuppress(
            VrCaseOverlaySketches);
        ...
        Logger.Info(
            "[_45CKFeatureRules] Right overlay -> " +
            "no VR case; normal W overlay sketch selected.");
    }
    ...
    {
        /*
         * A VR overlay case exists only when VR and VW
         * are both positive.
         */
        ...
        {
            Logger.Warn(
                "[_45CKFeatureRules] VR/VW is present but W or VW " +
                "is missing/not a length. No 45CK VR overlay case " +
                "was selected.");
