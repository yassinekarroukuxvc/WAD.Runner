...
/// <summary>
/// 45CK overlay tolerance rules.
/// Uses the exact 45CK overlay sketch/dimension names supplied by the model.
/// </summary>
public sealed class _45CKToleranceRules : IToleranceRuleSet
{
        ...
        WedgeFacts facts)
    {
        ...
        // 45CK only has the STD reference points used by this model.
        ...
        Logger.Info(
            "[_45CKToleranceRules] Overlay cut reference points -> " +
    ...
    {
        Logger.Warn(
            "[_45CKToleranceRules] Missing/invalid nominal or tolerance for " +
