...
public sealed class CobToleranceRules : IToleranceRuleSet
{
        ...
        WedgeSubclass subclass)
    {
        ...
        {
            Logger.Info(
                "[CobToleranceRules] Non-overlay drawing -> " +
        ...
        Logger.Info(
            $"[CobToleranceRules] Planned updates={updates.Count} " +
        ...
        CobShankType shank)
    {
        ...
        Logger.Info(
            "[CobToleranceRules] Overlay tolerance selection -> " +
            $"subclass={subclass}, " +
            $"shank={shank}, " +
            $"VBL present={hasVbl}, " +
            $"RA2 present={hasRa2}, " +
        ...
        CobShankType shank)
    {
        ...
        // RIGHT reference point: keep the existing COB calculation.
        var rightCutMm =
        ...
        Logger.Info(
            "[CobToleranceRules] Overlay cut reference points -> " +
            $"shank={shank}, " +
        ...
        string prefix)
    {
        ...
        Logger.Info(
            "[CobToleranceRules] FG foot tolerance selection -> " +
        ...
        bool hasVrVw)
    {
        ...
        {
            Logger.Warn(
                "[CobToleranceRules] VW is present but W is missing " +
    ...
    {
        Logger.Warn(
            "[CobToleranceRules] Missing or invalid nominal/" +
