...
namespace WAD.Runner.ModelAutomation.Rules.COB
{
    ...
    /// and applies COB-specific defaulting rules for missing inputs.
    /// </summary>
    public sealed class CobEquationInputNormalizer : IEquationInputNormalizer
    {
        ...
        private static void ApplyVraDefaultRule(WedgeData wedge, IDictionary<DimensionKey, Dimension> result)
        {
            ...
            Logger.Info("[CobEquationInputNormalizer] Rule applied: (VW/VRR/VR > 0) and (VRA missing/0) → VRA = 90deg");
        }
