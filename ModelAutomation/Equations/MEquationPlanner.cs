...
public sealed class MEquationPlanner : StandardEquationPlanner
{
        ...
        ModelAutomationContext context)
    {
        ...
        var wedge = context.Wedge
            ?? throw new InvalidOperationException(
                "WedgeData is required to build M equations.");
        ...
        WedgeFacts facts)
    {
        ...
        Logger.Info(
            $"[MEquationPlanner] funnel_gap={funnelGap} mm.");
    }
        ...
        WedgeSubclass subclass)
    {
        ...
        Logger.Info(
            "[MEquationPlanner] Overlay overrides -> " +
            $"subclass={subclass}, " +
            ...
            $"VBL={hasVbl}, " +
            $"RA2={hasRa2}, " +
            $"foot={(subclass == WedgeSubclass.FG ? ResolveFootKind(facts, ResolveNormalizedFootOption(facts)).ToString() : "N/A")}.");
    }
        ...
        bool useMaximum)
    {
        ...
        {
            Logger.Warn(
                $"[MEquationPlanner] Missing/invalid bounds for '{dimensionKey}'. " +
        ...
        bool useMaximum)
    {
        ...
        {
            Logger.Warn(
                $"[MEquationPlanner] Missing/invalid bounds for source '{sourceDimensionKey}'. " +
        ...
        bool useMaximum)
    {
        ...
        {
            Logger.Warn(
                $"[MEquationPlanner] Missing/invalid angle bounds for '{dimensionKey}'. " +
                $"{(useMaximum ? "MAX" : "MIN")} override skipped.");
        ...
        bool hasVrVw)
    {
        ...
        {
            Logger.Warn(
                "[MEquationPlanner] VW is present but W is missing/not a length. " +
                "VW case unresolved.");
