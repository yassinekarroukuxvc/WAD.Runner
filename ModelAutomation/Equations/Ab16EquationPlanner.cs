...
/// <summary>
/// Builds the equations used by the AB16 model.
///
/// Feed hole:
///     STD  -> keep H
///     Oval -> H = HH
...
public sealed class Ab16EquationPlanner : StandardEquationPlanner
{
        ...
        ModelAutomationContext context)
    {
        ...
        var wedge = context.Wedge
            ?? throw new InvalidOperationException(
                "WedgeData is required to build AB16 equations.");
        ...
        IDictionary<DimensionKey, DomDim> dimensions)
    {
        ...
        switch (token)
        {
            case "STD":
                Logger.Info(
                    "[Ab16EquationPlanner] Feed-hole type STD -> " +
        ...
        string feedHoleType)
    {
        ...
        {
            throw new InvalidOperationException(
                $"Cannot apply the AB16 {feedHoleType} feed-hole equation. " +
        ...
        Logger.Info(
            "[Ab16EquationPlanner] Feed-hole equation -> " +
            $"type={feedHoleType}, " +
        ...
        WedgeSubclass subclass)
    {
        ...
        if (isVg)
        {
            ...
            {
                throw new InvalidOperationException(
                    "Cannot calculate AB16 foot_depth. " +
        ...
        Logger.Info(
            "[Ab16EquationPlanner] Foot depth -> " +
        ...
        WedgeSubclass subclass)
    {
        ...
        Logger.Info(
            "[Ab16EquationPlanner] Overlay overrides -> " +
            $"subclass={subclass}, " +
            $"W override=" +
        ...
        bool useMaximum)
    {
        ...
        {
            Logger.Warn(
                "[Ab16EquationPlanner] Missing/invalid nominal or " +
