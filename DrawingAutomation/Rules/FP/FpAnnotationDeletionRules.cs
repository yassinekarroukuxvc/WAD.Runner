...
/// <summary>
/// FP Annotation deletion planning.
///
/// FP uses the same annotation deletion behavior as COB.
/// So this class is the FP counterpart of CobAnnotationDeletionRules,
/// with the same logic and rule set.
/// </summary>
