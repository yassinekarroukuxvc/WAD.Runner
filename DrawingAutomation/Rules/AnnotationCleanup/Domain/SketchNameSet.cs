...
{
    public static SketchNameSet Empty { get; } = new()
    {
        FrontSketch = string.Empty,
        TopSketch = string.Empty,
        FrBrSketch = string.Empty
    };
    ...
    public string CgDeg180TypoSketch { get; init; } =
