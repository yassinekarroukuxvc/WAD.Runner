...
namespace WAD.Runner.DrawingAutomation.Executors.PGB
{
    public static class PgbProductionDrawingExecutor
    {
            ...
            Func<object?> runPartAutomation)
        {
            ...
            DrawingExecutorPipeline.LogBanner("=== WAD ▶ PGB/Production (Placement + Autoscale) ===");
            ...
            // - CKVD only: delete zero-valued annotations (you asked: only CKVD does this)
            ...
            // - COB cleanup if you ever route COB through PGB executor
