...
public sealed class CobAnnotationContextResolver : IAnnotationWedgeContextResolver
{
    ...
    public AnnotationWedgeContext Resolve(WedgeData wedge)
    {
        ...
        return new AnnotationWedgeContext
        {
            Traits = new AnnotationTraitSet(new[]
            {
                ...
                Pair(CobAnnotationTraitNames.FroEqualsFr, froEqualsFr)
            }),
    ...
    private static string ResolveShankToken(WedgeData wedge)
    {
        ...
        return token switch
        {
            "SW_STD" or "STD" => CobAnnotationShankTypes.Std,
            "SW_180REV" or "SW_180_REV" or "180REV" or "180_REV" => CobAnnotationShankTypes.Rev,
            _ => token
        };
    }
    ...
    private static string ResolveFootToken(WedgeData wedge, DrawingWedgeFacts facts)
    {
        ...
        return token switch
        {
            "LW_VG" or "SW_VG" or "VG" => CobAnnotationFootOptions.Vg,
            "LW_G" or "SW_G" or "G" => CobAnnotationFootOptions.G,
            "LW_C" or "SW_C" or "C" => HasCbr(facts)
                ? CobAnnotationFootOptions.CWithCbr
                : CobAnnotationFootOptions.C,
            _ => CobAnnotationFootOptions.FlatOrUnknown
        };
    }
