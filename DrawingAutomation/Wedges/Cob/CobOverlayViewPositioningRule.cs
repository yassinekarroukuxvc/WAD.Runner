...
public sealed class CobOverlayViewPositioningRule : OverlayViewPositioningRuleBase
{
    ...
    public override string Name => "COB overlay positioning";
        ...
        OverlayViewPositioningContext context)
    {
        ...
        Logger.Info(
            "[Overlay][COB] Reference-point selection -> " +
