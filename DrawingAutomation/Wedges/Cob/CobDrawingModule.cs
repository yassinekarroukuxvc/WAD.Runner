...
using WAD.Runner.DrawingAutomation.Wedges.Cob.Annotations;

namespace WAD.Runner.DrawingAutomation.Wedges.Cob;

public sealed class CobDrawingModule : IDrawingWedgeModule
{
    ...
    public CobDrawingModule()
    {
        ...
        {
            DrawingProfileFactory.Create(WedgeType, WedgeSubclass.FG, DrawingType.Production, "COB FG Production", ProductionCustomerViews, new[] { "SHEET1" }, DrawingViewNames.SecondaryBreaklineViews),
            DrawingProfileFactory.Create(WedgeType, WedgeSubclass.FG, DrawingType.Customer, "COB FG Customer", ProductionCustomerViews, new[] { "SHEET1" }, DrawingViewNames.SecondaryBreaklineViews),
            DrawingProfileFactory.Create(WedgeType, WedgeSubclass.FG, DrawingType.Overlay, "COB FG Overlay", OverlayViews, new[] { "OVERLAY" }, DrawingViewNames.NoBreaklineViews),
            DrawingProfileFactory.Create(WedgeType, WedgeSubclass.PGB, DrawingType.Production, "COB PGB Production", ProductionCustomerViews, new[] { "SHEET1" }, DrawingViewNames.SecondaryBreaklineViews),
            DrawingProfileFactory.Create(WedgeType, WedgeSubclass.PGB, DrawingType.Customer, "COB PGB Customer", ProductionCustomerViews, new[] { "SHEET1" }, DrawingViewNames.SecondaryBreaklineViews),
            DrawingProfileFactory.Create(WedgeType, WedgeSubclass.PGB, DrawingType.Overlay, "COB PGB Overlay", OverlayViews, new[] { "OVERLAY" }, DrawingViewNames.NoBreaklineViews)
        });
    }

    public WedgeType WedgeType => global::WAD.Runner.DataManagement.Domain.Wedge.WedgeType.COB;
    ...
    public IOverlayViewPositioningRule OverlayPositioningRule { get; } =
        new CobOverlayViewPositioningRule();
    ...
    public IReadOnlyList<IAnnotationRuleCatalog> AnnotationCatalogs { get; } =
        ...
        {
            new CobFgProductionAnnotationRules(),
            new CobFgCustomerAnnotationRules(),
            new CobFgOverlayAnnotationRules(),
            new CobPgbProductionAnnotationRules(),
            new CobPgbOverlayAnnotationRules()
        });

    public IAnnotationWedgeContextResolver AnnotationContextResolver { get; } =
        new CobAnnotationContextResolver();
        ...
        DrawingType drawingType)
    {
        if (subclass == WedgeSubclass.PGB)
        {
            return drawingType == DrawingType.Overlay
                ? AnnotationCleanupProfile.CobPgbOverlay
                : AnnotationCleanupProfile.CobPgbProduction;
        }

        return drawingType switch
        {
            DrawingType.Overlay => AnnotationCleanupProfile.CobFgOverlay,
            DrawingType.Customer => AnnotationCleanupProfile.CobFgCustomer,
            _ => AnnotationCleanupProfile.CobFgProduction
        };
    }
