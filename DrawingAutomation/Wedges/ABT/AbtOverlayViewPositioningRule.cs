...
public sealed class AbtOverlayViewPositioningRule : OverlayViewPositioningRuleBase
{
    ...
    public override string Name => "ABT overlay positioning";

    public override IReadOnlyList<OverlayViewPlacement> BuildPlacements(OverlayViewPositioningContext context)
    {
        var detailReferencePoint = context.IsReverse180 ? RevDetailReferencePoint : StdDetailReferencePoint;
        var sectionReferencePoint = context.IsReverse180 ? RevSectionReferencePoint : StdSectionReferencePoint;

        Logger.Info(
            "[Overlay][ABT] Reference-point selection -> " +
