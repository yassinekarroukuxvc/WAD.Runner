...
public sealed class MDrawingModule : IDrawingWedgeModule
{
    ...
    public MDrawingModule()
    {
        Profiles = Array.AsReadOnly(new[]
        {
            DrawingProfileFactory.Create(WedgeType, WedgeSubclass.FG, DrawingType.Production, "M FG Production", ProductionCustomerViews, new[] { "SHEET1" }, DrawingViewNames.SecondaryBreaklineViews),
            DrawingProfileFactory.Create(WedgeType, WedgeSubclass.FG, DrawingType.Customer, "M FG Customer", ProductionCustomerViews, new[] { "SHEET1" }, DrawingViewNames.SecondaryBreaklineViews),
            DrawingProfileFactory.Create(WedgeType, WedgeSubclass.FG, DrawingType.Overlay, "M FG Overlay", OverlayViews, new[] { "OVERLAY" }, DrawingViewNames.NoBreaklineViews),
            DrawingProfileFactory.Create(WedgeType, WedgeSubclass.PGB, DrawingType.Production, "M PGB Production", ProductionCustomerViews, new[] { "SHEET1" }, DrawingViewNames.SecondaryBreaklineViews),
            DrawingProfileFactory.Create(WedgeType, WedgeSubclass.PGB, DrawingType.Customer, "M PGB Customer", ProductionCustomerViews, new[] { "SHEET1" }, DrawingViewNames.SecondaryBreaklineViews),
            DrawingProfileFactory.Create(WedgeType, WedgeSubclass.PGB, DrawingType.Overlay, "M PGB Overlay", OverlayViews, new[] { "OVERLAY" }, DrawingViewNames.NoBreaklineViews)
        });
    }

    public WedgeType WedgeType => global::WAD.Runner.DataManagement.Domain.Wedge.WedgeType.M;
    ...
    public IOverlayViewPositioningRule OverlayPositioningRule { get; } =
        new MOverlayViewPositioningRule();
    ...
    public IReadOnlyList<IAnnotationRuleCatalog> AnnotationCatalogs { get; } =
        ...
        {
            new MFgProductionAnnotationRules(),
            new MFgCustomerAnnotationRules(),
            new MFgOverlayAnnotationRules(),
            new MPgbProductionAnnotationRules(),
            new MPgbOverlayAnnotationRules()
        });

    public IAnnotationWedgeContextResolver AnnotationContextResolver { get; } =
        new MAnnotationContextResolver();
        ...
        DrawingType drawingType)
    {
        ...
        {
            DrawingType.Overlay => AnnotationCleanupProfile.MFgOverlay,
            DrawingType.Customer => AnnotationCleanupProfile.MFgCustomer,
            _ => AnnotationCleanupProfile.MFgProduction
        };
    }
