...
public sealed class UtusOverlayViewPositioningRule : OverlayViewPositioningRuleBase
{
    ...
    public override string Name => "UTUS overlay positioning";
        ...
        OverlayViewPositioningContext context)
    {
        ...
        Logger.Info(
            "[Overlay][UTUS] Reference-point selection -> " +
