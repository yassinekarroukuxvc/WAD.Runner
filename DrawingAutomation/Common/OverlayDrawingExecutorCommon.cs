    ...
    public static class OverlayDrawingExecutorCommon
    {
        ...
        public static string[] DefaultOverlayDimKeys(WedgeType wedgeType) => wedgeType switch
        {
            WedgeType.COB => new[]
            {
                ...
                "H", "FNO", "FNA", "FL", "ERL", "ERD", "CBRL", "CBRD"
            },
        ...
        public static void TryRepositionAllOverlayViews(SldWorks swApp, DrawingService ds, DrawingRun run, IDictionary<string, string> nameMap)
        {
            try
            {
